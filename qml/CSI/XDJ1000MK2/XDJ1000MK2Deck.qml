...
//------------------------------------------------------------------------------------------------------------------
  ...
  XDJCommonDeck { name: "common_deck"; deckId: deck.deckId; active: deck.active }

  BrowserModule { name: "browser"; deckId: deck.deckId; lines: 7; useHeader: true; active: deck.active }

  Waveform { name: "waveform"; deckId: deck.deckId; active: deck.active }

  Stripe { name: "stripe"; deckId: deck.deckId; active: deck.active  }

  XDJ1000MK2HotCues { name: "hotcues"; deckId: deck.deckId; active: deck.active }

  XDJPhaseMeter { name: "phase_meter"; channel: deckId }
  Wire { from: "surface.deck_phase_info"; to:"phase_meter.deck.value"; enabled: deck.active }
  Wire { from: "surface.master_phase_info"; to:"phase_meter.master.value"; enabled: deck.active }
}
