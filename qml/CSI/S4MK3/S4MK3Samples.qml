...
Module
{
    ...
    RemixMixing { name: "mixing"; channel: deckId }
    ...
    function playerPath(playerId) {
        return "app.traktor.decks." + module.deckId + ".remix.players." + playerId;
    }
    ...
    WiresGroup
  {
        ...
        WiresGroup
        {
          ...
          Wire { from: "%surface%.loop_size.push";  to: TogglePropertyAdapter  { path: "app.traktor.decks." + deckId + ".remix.quant" } }
          Wire { from: "%surface%.loop_size.turn";  to: RelativePropertyAdapter { path:"app.traktor.decks." + deckId + ".remix.quant_index"; mode: RelativeMode.Stepped } }
        }
        ...
        WiresGroup
        {
          ...
          Wire { from: "%surface%.record"; to: TogglePropertyAdapter  { path: "app.traktor.decks." + deckId + ".remix.sequencer.rec.on" } }
          Wire { from: "%surface%.record"; to: SetPropertyAdapter	 { path: "app.traktor.decks." + deckId + ".remix.sequencer.on"; value: true; output: false } }
