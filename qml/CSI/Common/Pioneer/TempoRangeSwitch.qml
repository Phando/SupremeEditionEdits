...
Module {
  ...
  AppProperty { id: tempoRange; path:"app.traktor.decks." + deckId + ".tempo.range_select" }
  ...
  Wire { from: "surface.tempo_range"; to: ButtonScriptAdapter { onPress: { tempoRange.value = getNextSupportedRange() } } enabled: active }
}
