...
Module {
		...
		MappingPropertyDescriptor {
			...
			[
		  		...
		  		MappingPropertyValue { value: -6;  description: "-1/2"   },
		  		MappingPropertyValue { value: -5;  description: "-1/4"   },
		  		MappingPropertyValue { value: -4;  description: "-1/8"   },
		  		MappingPropertyValue { value: -3;  description: "-1/16"  },
		  		MappingPropertyValue { value: 3;   description: "+1/16"  },
		  		MappingPropertyValue { value: 4;   description: "+1/8"   },
		  		MappingPropertyValue { value: 5;   description: "+1/4"   },
		  		MappingPropertyValue { value: 6;   description: "+1/2"   },
