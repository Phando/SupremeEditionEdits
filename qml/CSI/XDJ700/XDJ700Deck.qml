...
//------------------------------------------------------------------------------------------------------------------
  ...
  XDJCommonDeck { name: "common_deck"; id: commonDeck; deckId: deck.deckId; active: deck.active }

  BrowserModule { name: "browser"; deckId: deck.deckId; lines: 7; useHeader: false; active: deck.active }

  Stripe { name: "stripe"; deckId: deck.deckId; width: 400; height: 26; active: deck.active  }

  XDJ700HotCues { name: "hotcues"; deckId: deck.deckId; active: deck.active }
