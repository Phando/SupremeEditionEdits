...
//------------------------------------------------------------------------------------------------------------------
    ...
    XDJ700Preferences { name: "preferences"; id: preferences }
...
//------------------------------------------------------------------------------------------------------------------
    ...
    XDJ700Deck { name:"deck_a"; id: deckA; deckId: 1; active: deckSelection.selectedDeck === 1 }
    XDJ700Deck { name:"deck_b"; id: deckB; deckId: 2; active: deckSelection.selectedDeck === 2 }
    XDJ700Deck { name:"deck_c"; id: deckC; deckId: 3; active: deckSelection.selectedDeck === 3 }
    XDJ700Deck { name:"deck_d"; id: deckD; deckId: 4; active: deckSelection.selectedDeck === 4 }
