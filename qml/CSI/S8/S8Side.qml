...
Module {
    ...
    property alias topFXUnit: topFXUnit.value //INFO: Necessary for ?
    property alias bottomFXUnit: bottomFXUnit.value //INFO: Necessary for ?

    property var activeSide: topDeckId == 1 ? ScreenSide.Left : ScreenSide.Right
...
//------------------------------------------------------------------------------------------------------------------
    ...
    function initializeModule() {
        ...
        activePadsMode.value = focusedDeck().padsMode //TODO: this isn't working --> when updating pads when loading deck for the first time --> skips directly to the else{ activePadsMode.value=PadsMode.disabled}
...
//------------------------------------------------------------------------------------------------------------------
    ...
    property double preEditZoom: 0.0
