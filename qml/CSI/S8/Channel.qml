...
Module {
    ...
    Wire { from: "%surface%.filter_on"; to: DirectPropertyAdapter { path: "app.traktor.mixer.channels." + deckId + ".fx.on" } }
    Wire { from: "%surface%.cue"; to: DirectPropertyAdapter { path: "app.traktor.mixer.channels." + deckId + ".cue" } }
