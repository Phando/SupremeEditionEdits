...
Item
{
  ...
  readonly property color   color:		isEmpty ? colors.brightGrey : colors.palette(computeBrightness(propState.description, propDisplayState.description), propColorId.value)
  readonly property color   brightColor:  isEmpty ? colors.brightGrey : colors.palette(1., propColorId.value)
  readonly property color   midColor:	 isEmpty ? colors.grey : colors.palette(0.5, propColorId.value)
  readonly property color   dimmedColor:  isEmpty ? colors.darkGrey : colors.palette(0., propColorId.value)
