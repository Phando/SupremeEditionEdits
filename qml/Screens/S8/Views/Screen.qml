...
//------------------------------------------------------------------------------------------------------------------
    ...
    //Header Fields
    MappingProperty { id: displayTopLeft; path: "mapping.settings.displayTopLeft" }
    MappingProperty { id: displayTopMid; path: "mapping.settings.displayTopMid" }
    MappingProperty { id: displayTopRight; path: "mapping.settings.displayTopRight" }

    MappingProperty { id: displayMidLeft; path: "mapping.settings.displayMidLeft" }
    MappingProperty { id: displayMidMid; path: "mapping.settings.displayMidMid" }
    MappingProperty { id: displayMidRight; path: "mapping.settings.displayMidRight" }

    MappingProperty { id: displayBottomLeft; path: "mapping.settings.displayBottomLeft" }
    MappingProperty { id: displayBottomMid; path: "mapping.settings.displayBottomMid" }
    MappingProperty { id: displayBottomRight; path: "mapping.settings.displayBottomRight" }
  /*
