...
//--------------------------------------------------------------------------------------------------------------------
  ...
  Widgets.BeatCounter {
    ...
    anchors.topMargin: 36
    anchors.horizontalCenter: parent.horizontalCenter
    visible: deckSize != "small" && !beatmatchPracticeMode.value && (phaseWidget.value == 2 || (phaseWidget.value == 3 && isLoaded.value && (masterDeckType.value == DeckType.Remix || masterId.value == -1)))
  ...
  Item {
    ...
    Widgets.WaveformBeatCounter{
        ...
        masterColor: masterId.value != -1 ? deckColor : colors.cyan
        deckColor: deckColor
        masterLetter: true
    }
  }
